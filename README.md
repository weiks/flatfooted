...
```
# Every minute
*/1 * * * * python3 -u /path/to/main.py | tee /path/to/outputs/log.txt

# Every hour (sharp)
0 * * * * python3 -u /path/to/main.py | tee /path/to/outputs/log.txt

# Every day (midnight)
0 0 * * * python3 -u /path/to/main.py | tee /path/to/outputs/log.txt

# Every week (Sunday midnight)
0 0 0 * * python3 -u /path/to/main.py | tee /path/to/outputs/log.txt
```
